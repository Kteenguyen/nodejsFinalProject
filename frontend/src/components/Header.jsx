            ...
            <div className="flex items-center space-x-4">
                ...
                >
                    ...
                    {dropdownOpen && (
                        ...
                        >
                            <button className="block w-full text-left px-4 py-2 text-gray-800 hover:bg-blue-100 hover:border-l-4 hover:border-blue-400 transition duration-150 ease-in-out">Đăng nhập</button>
                            <button className="block w-full text-left px-4 py-2 text-gray-800 hover:bg-blue-100 hover:border-l-4 hover:border-blue-400 transition duration-150 ease-in-out">Đăng ký</button>
                        </div>
                    )}
                </div>
            </div>
